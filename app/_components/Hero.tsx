  ...
  return (
    <div className="container mx-auto flex flex-col items-center lg:mt-28 mt-14  ">
      <div className="flex flex-col  px-2">
        ...
        <p className="lg:text-5xl font-semibold mt-2 text-2xl px-3 text-center">
          {" "}
          business from one dashboard.
        </p>
        ...
        <p className="mt-3 text-center text-hero-secondary text-sm">
          Manage your products, orders, shipping, POS, discounts, and payouts
          seamlessly
          <span className="text-center text-hero-secondary max-lg:px-4 text-sm lg:block inline">
      ...
      <div className="lg:mt-0 mt-8">
        ...
        <div className="flex lg:w-300 max-lg:overflow-x-scroll  lg:justify-evenly  space-x-4   lg:mt-6 px-4 mt-4">
          {images.map((el, i) => (
            <div key={i}>
              <Image
                src={el}
